...
import styles from './DocumentProgressStep.module.scss';
...
export const DocumentProgressStep = ({document, isCurrentDocument, currentPageIndex: currentPage, signedPageIndices: signedPages, docClicked, stepClicked}: DocumentStepProperties) => {
  if (document) {
