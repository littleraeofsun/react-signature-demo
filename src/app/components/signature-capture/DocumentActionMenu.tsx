...
import styles from './DocumentActionMenu.module.scss';
...
export const DocumentActionMenu = ({currentPageIndex, currentPageRequiresSignature, isCurrentPageSigned, totalPages, acknowledgeClicked, continueClicked}: DocumentMenuProperties) => {
